...
export const stations: StationDefinition[] = [
  ...
  },
  {
    ...
    video: media('observation-forest-desktop.mp4'),
    mobileVideo: media('observation-forest-mobile.mp4'),
    poster: media('observation-forest.webp'),
    accent: '#b9ef74',
    choices: [
  ...
  },
  {
    ...
    video: media('map-black-hole-desktop.mp4'),
    mobileVideo: media('map-black-hole-mobile.mp4'),
    poster: media('map-black-hole.webp'),
    accent: '#ff8d7a',
    choices: [
  ...
  },
  {
    ...
    video: media('expression-triptych-desktop.mp4'),
    mobileVideo: media('expression-triptych-mobile.mp4'),
    poster: media('expression-triptych.webp'),
    accent: '#80b8ff',
    choices: [
